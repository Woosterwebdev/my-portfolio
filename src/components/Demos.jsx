    ...
    return (
        <section className="demos max-width">
            ...
            <div className="project-cards-container">
                <a href="https://github.com/Woosterwebdev/3DPrintsList" target="_blank">
                    <div className="project-card">
                        <div className="project-details">
                            ...
                            <p>This is a Chrome extension I created to help me track 3D models over various sites. With this app 
                                I am able to drastically reduce the number of models I lose track of. This link will take you to 
                                the extensions repo.</p>
                        </div>
                        <img className="screenshot" src="/assets/3dprintslist-screenshot.png" alt="3D Print List Chrome Extension." />
                    </div>
                </a>
